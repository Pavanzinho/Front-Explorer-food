...
export function NewPlate() {
    ...
    const [plate_category, setPlateCategory] = useState("");
    ...
    async function handleNewPlate() {
        ...
        if (newIngredient) {
            alert(`você inseriu algum ingredientes mas não o adicionou. Clique em + para adicionar, ou deixe vazio`)
            return
        }
        ...
        try {
            ...
            if (avatarFile) {
                ...
                formData.append("plate_category", plate_category)
    ...
    return (
        <Container>
            < Header type="admHeader" newplate="true">
                        ...
                        <div className="definingDisplay">
                            ...
                            <label>
                                ...
                                <div className="inputContainer dark900">
                                    <select id="foodCategory" onChange={e => setPlateCategory(e.target.value)}>
                                        <option
                                            value="refeições"
                        ...
                        <div className="definingDisplay2">
                            ...
                            <label htmlFor="nameFoodInput">
                                ...
                                <div className={`inputContainer ${error ? 'error' : ''}`}>
                                    ...
                                    />
                                    {error ? <span className="notificationPlatePrice"> Apenas digitos numéricos</span> : ""}
                                </div>
                            </label>
